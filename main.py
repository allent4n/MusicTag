...
# CNN_LSTM Prediting
def cnn_lstm_predict(model, audio_file, seq_len, device, max_length, word_token):
    '''
    Developed by: TAN Zusheng
    ...
    with torch.no_grad():
        ...
        _, (hidden, cell) = model.encoder_rnn(conv_out)
...
def main():
    '''
    Developed by: TAN Zusheng
    This is the main function for the CNN_LSTM model.
